...
describe('Service Tests', () => {
    ...
    describe('DeductionType Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(DeductionTypeService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/deduction-types/' + 123);
            });
            it('should return DeductionType', () => {

                let entity: DeductionType;
                service.find(123).subscribe((_entity: DeductionType) => {
                    entity = _entity;
                });
