...
describe('Service Tests', () => {
    ...
    describe('MaritalStatus Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(MaritalStatusService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/marital-statuses/' + 123);
            });
            it('should return MaritalStatus', () => {

                let entity: MaritalStatus;
                service.find(123).subscribe((_entity: MaritalStatus) => {
                    entity = _entity;
                });
