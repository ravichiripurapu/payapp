...
describe('Service Tests', () => {
    ...
    describe('DeductionSubType Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(DeductionSubTypeService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/deduction-sub-types/' + 123);
            });
            it('should return DeductionSubType', () => {

                let entity: DeductionSubType;
                service.find(123).subscribe((_entity: DeductionSubType) => {
                    entity = _entity;
                });
