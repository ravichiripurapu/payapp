...
describe('Service Tests', () => {
    ...
    describe('PayrollEmployeeTaxes Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(PayrollEmployeeTaxesService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/payroll-employee-taxes/' + 123);
            });
            it('should return PayrollEmployeeTaxes', () => {

                let entity: PayrollEmployeeTaxes;
                service.find(123).subscribe((_entity: PayrollEmployeeTaxes) => {
                    entity = _entity;
                });
