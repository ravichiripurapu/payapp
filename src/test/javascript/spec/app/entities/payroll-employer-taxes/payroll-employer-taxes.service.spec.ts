...
describe('Service Tests', () => {
    ...
    describe('PayrollEmployerTaxes Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(PayrollEmployerTaxesService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/payroll-employer-taxes/' + 123);
            });
            it('should return PayrollEmployerTaxes', () => {

                let entity: PayrollEmployerTaxes;
                service.find(123).subscribe((_entity: PayrollEmployerTaxes) => {
                    entity = _entity;
                });
