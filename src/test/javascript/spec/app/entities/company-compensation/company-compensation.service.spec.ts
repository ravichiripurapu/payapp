...
describe('Service Tests', () => {
    ...
    describe('CompanyCompensation Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(CompanyCompensationService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/company-compensations/' + 123);
            });
            it('should return CompanyCompensation', () => {

                let entity: CompanyCompensation;
                service.find(123).subscribe((_entity: CompanyCompensation) => {
                    entity = _entity;
                });
