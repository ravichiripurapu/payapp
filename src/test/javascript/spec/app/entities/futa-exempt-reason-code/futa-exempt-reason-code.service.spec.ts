...
describe('Service Tests', () => {
    ...
    describe('FutaExemptReasonCode Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(FutaExemptReasonCodeService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/futa-exempt-reason-codes/' + 123);
            });
            it('should return FutaExemptReasonCode', () => {

                let entity: FutaExemptReasonCode;
                service.find(123).subscribe((_entity: FutaExemptReasonCode) => {
                    entity = _entity;
                });
