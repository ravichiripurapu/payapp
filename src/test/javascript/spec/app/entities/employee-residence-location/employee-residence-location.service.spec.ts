...
describe('Service Tests', () => {
    ...
    describe('EmployeeResidenceLocation Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(EmployeeResidenceLocationService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/employee-residence-locations/' + 123);
            });
            it('should return EmployeeResidenceLocation', () => {

                let entity: EmployeeResidenceLocation;
                service.find(123).subscribe((_entity: EmployeeResidenceLocation) => {
                    entity = _entity;
                });
