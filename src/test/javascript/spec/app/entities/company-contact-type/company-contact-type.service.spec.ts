...
describe('Service Tests', () => {
    ...
    describe('CompanyContactType Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(CompanyContactTypeService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/company-contact-types/' + 123);
            });
            it('should return CompanyContactType', () => {

                let entity: CompanyContactType;
                service.find(123).subscribe((_entity: CompanyContactType) => {
                    entity = _entity;
                });
