...
describe('Service Tests', () => {
    ...
    describe('EmployeeWorkLocation Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(EmployeeWorkLocationService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/employee-work-locations/' + 123);
            });
            it('should return EmployeeWorkLocation', () => {

                let entity: EmployeeWorkLocation;
                service.find(123).subscribe((_entity: EmployeeWorkLocation) => {
                    entity = _entity;
                });
