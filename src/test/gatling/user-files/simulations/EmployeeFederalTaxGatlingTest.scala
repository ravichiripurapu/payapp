...
/**
 * Performance test for the EmployeeFederalTax entity.
 */
class EmployeeFederalTaxGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the EmployeeFederalTax entity")
        ...
        .pause(10)
        .repeat(2) {
            exec(http("Get all employeeFederalTaxes")
            .get("/api/employee-federal-taxes")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
