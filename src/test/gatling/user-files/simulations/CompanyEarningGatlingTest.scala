...
/**
 * Performance test for the CompanyEarning entity.
 */
class CompanyEarningGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the CompanyEarning entity")
        ...
        .pause(10)
        .repeat(2) {
            exec(http("Get all companyEarnings")
