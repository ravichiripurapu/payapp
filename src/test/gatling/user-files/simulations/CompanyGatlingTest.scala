...
class CompanyGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Company entity")
        ...
        .repeat(2) {
            ...
            .post("/api/companies")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "companyName":"SAMPLE_TEXT", "website":"SAMPLE_TEXT", "fein":"SAMPLE_TEXT", "defaultFullTimeHours":"0", "defaultPartTimeHours":"0", "defaultTemporaryHours":"0", "payrollFrequency":"SAMPLE_TEXT", "createdDate":"2020-01-01T00:00:00.000Z", "createdBy":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
